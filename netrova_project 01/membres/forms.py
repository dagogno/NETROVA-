...
class InscriptionForm(forms.Form):
    ...
    # KYC — optionnel à l'inscription, requis après la 3e commande soldée
    photo_profil         = forms.ImageField(required=False, label='Photo de profil (optionnel)', help_text='Vous pourrez l\'ajouter plus tard depuis votre profil.')
    carte_identite_recto = forms.ImageField(required=False, label='CNI / Passeport Recto (optionnel)', help_text='Requis après votre 3e commande soldée.')
