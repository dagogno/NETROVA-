...
class Membre(models.Model):
    ...
    KYC_SEUIL_COMMANDES    = 3  # KYC requis après N commandes soldées
    # Score
    ...
    @property
    def kyc_requis_maintenant(self):
        """True si le membre a atteint le seuil et n'a pas encore validé son KYC."""
        return (
            self.nb_commandes_soldees >= self.KYC_SEUIL_COMMANDES
            and self.kyc_statut in ('non_requis', 'rejete')
        )
